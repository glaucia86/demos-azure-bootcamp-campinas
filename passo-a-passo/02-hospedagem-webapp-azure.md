# Hospedagem de Aplicações Web no Azure: TODO List MEAN

[![bit-azure.png](https://i.postimg.cc/ZKwS8SHj/bit-azure.png)](https://postimg.cc/vcxkyCp6)

Nesse exemplo abaixo estaremos integrando uma aplicação MEAN (Mongo, Express, Angular & Node.js) ao **[Azure App Service](https://aka.ms/AA4qm7c)** integrando o banco MongoDb ao **[CosmosDb](https://aka.ms/AA4qm7e)**

## Agenda - Lab 02

Esse laboratório (código) pode ser encontrado **[AQUI - Repositório: Azure Fundamentals](https://github.com/glaucia86/workshop-azure-fundamentals)**
